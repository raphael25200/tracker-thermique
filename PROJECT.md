...
- **Aucun accès distant à MySQL** depuis l'extérieur (confirmé par le support OVH) — toute migration de données doit se faire *depuis* le serveur, jamais depuis un PC local
